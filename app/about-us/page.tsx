...
export default function AboutUs() {
  ...
  useGSAP(() => {
    ...
    // Word by word reveal
    const missionWords = gsap.utils.toArray<HTMLElement>('.mission-reveal-word');
    ...
    if (founderCard) {
      ...
      founderCard.addEventListener('mousemove', (e) => {
        ...
        requestAnimationFrame(() => {
          ...
          const x = (mouseEvent.clientX - rect.left - rect.width / 2) * 0.05;
          const y = (mouseEvent.clientY - rect.top - rect.height / 2) * -0.05;
    ...
    const counters = gsap.utils.toArray<HTMLElement>('.impact-number');
